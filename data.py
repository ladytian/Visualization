...
def main():
	...
	output = open('D:\workspace\Visualization\complete data\ing\out1.json', 'a')
	reader = csv.reader(open(r"D:\workspace\Visualization\Teachers_roaming_day_0307_0414\test.csv"))
	reader.next()
